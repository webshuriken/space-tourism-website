        ...
        </h5>
        {
          spinnerLoading
            ?
              ...
              />
            :
              <article className='grid pt-[32px] lg:grid-cols-[1fr,1fr] lg:grid-rows-[58px_auto_58px] xl:grid-cols-[auto_515px] xl:grid-rows-[114px_auto_114px]'>
                <div className='relative grid content-end h-[170px] overflow-hidden md:h-[310px] lg:col-start-2 lg:col-span-1 lg:row-start-1 lg:row-span-3 lg:content-center lg:self-center lg:order-2 xl:h-full'>
                ...
                <div className='grid px-[24px] lg:grid-cols-[124px,auto] lg:grid-rows-[auto,auto] lg:col-start-1 lg:col-span-1 lg:row-start-2 lg:row-span-1 lg:order-1 xl:grid-cols-[188px,auto]'>
                  ...
                  <div className='pt-5 text-center lg:col-start-2 lg:col-span-1 lg:row-start-1 lg:row-span-1 lg:text-left uppercase'>
                    ...
                    <h3 className='font-h3 text-h3-sm md:text-h3-md xl:text-h3-lg'>{technology.name}</h3>
                  </div>
