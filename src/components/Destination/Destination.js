...
export default function Destination() {
  ...
  return (
    <section className="app-page pt-[88px] md:pt-[130px]" style={{backgroundImage: `url(${bgImage})`}}>
      ...
      <article className='grid grid-cols-[100%] grid-rows-[170px_auto] md:grid-cols-[574px] md:grid-rows-[300px_auto] place-items-center place-content-center gap-4 md:gap-12 pt-8 md:pt-16'>
        <picture className='block realtive h-[170px] w-[170px] md:h-[300px] md:w-[300px]'>
        ...
        <div className='grid  place-items-center grid-rows-[repeat(5, auto)] pt-[6px]'>
          ...
          <div className='flex flex-col md:flex-row gap-[32px] md:gap-0 pb-16 md:pb-8 w-full'>
