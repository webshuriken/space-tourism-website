...
export default function TechnologyMenu({technologyList, handleClick}) {
  ...
  return (
    <ul className="flex justify-between justify-self-center w-[152px] pt-8 pb-2 md:w-[210px] md:pt-16 lg:flex-col lg:col-start-1 lg:col-span-1 lg:row-start-1 lg:row-span-2 lg:self-start lg:h-[304px] lg:w-[80px] lg:p-0">
      {
          ...
          return (
            <li key={i} className={`${activeBtnClass}technology-menu__item relative`} data-btn-value={btnNumber}>
              <button 
                ...
                value={tech.name}
                className='technology-menu__btn relative h-[40px] w-[40px] text-[1.06rem] rounded-full overflow-hidden md:h-[60px] md:w-[60px] md:text-[1.6rem] xl:h-[80px] xl:w-[80px] xl:text-[2.14rem]'
